        ...
        <header className="bg-[#202020] flex flex-row py-4 justify-between items-center">
            <div className="flex flex-row gap-2 text-center ml-16">
                <div className='relative group'>
                    ...
                    <p className='absolute left-1/2 transform -translate-x-1/2 mt-4 ml-32 w-[300px] p-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-10'>
